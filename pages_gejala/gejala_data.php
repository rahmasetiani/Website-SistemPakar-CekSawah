  ...
  <div class="mb-3">
    <form action="?open=Gejala-Add&status=tambah" target="_self" method="Post">
      ...
      <table class="table table-striped table-bordered">
        ...
        while ($data = mysqli_fetch_array($tampil)) {
          echo "<tr>
                  ...
                  <td align='center'><a href='?open=Gejala-Edit&kode={$data['kd_gejala']}' class='btn btn-warning btn-sm'>Ubah</a></td> 
                  <td align='center'><a href='?open=Gejala-Hapus&kode={$data['kd_gejala']}' class='btn btn-danger btn-sm'>Hapus</a></td>
                </tr>";
          $no++;
        }
        ?>
      ...
      for ($a = 1; $a <= $jmlhalaman; $a++) {
        if ($a != $halaman) {
          echo "<li class='page-item'><a class='page-link' href='?open=Gejala-Data&halaman=$a'>$a</a></li>";
        } else {
